...
SOUNDS = {
	...
	-- Saffron
	{fromPos = {x=1057, y=1016, z=15}, toPos = {x=1110, y=1028, z=15}, priority = 2, sound="cidade 2.ogg"},
	...
	-- Main
		...
		-- Saffron
		{fromPos = {x=1024, y=1022, z=7}, toPos = {x=1049, y=1037, z=7}, priority = 2, sound="center.ogg"},
		{fromPos = {x=1024, y=1022, z=6}, toPos = {x=1049, y=1037, z=6}, priority = 2, sound="center.ogg"},
		{fromPos = {x=1024, y=1022, z=5}, toPos = {x=1049, y=1037, z=5}, priority = 2, sound="center.ogg"},
		{fromPos = {x=1030, y=1038, z=7}, toPos = {x=1036, y=1039, z=7}, priority = 2, sound="center.ogg"},
		{fromPos = {x=1030, y=1038, z=6}, toPos = {x=1036, y=1039, z=6}, priority = 2, sound="center.ogg"},
		{fromPos = {x=1030, y=1038, z=5}, toPos = {x=1036, y=1039, z=5}, priority = 2, sound="center.ogg"},
